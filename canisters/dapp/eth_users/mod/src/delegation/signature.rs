...
use crate::common::{DEFAULT_SIGNATURE_EXPIRATION_PERIOD_NS, LABEL_ASSETS, LABEL_SIG};
use crate::types::{Delegation, PublicKey, Timestamp};
...
pub fn update_root_hash(a: &AssetHashes, m: &SignatureMap) {
...
pub fn prune_expired_signatures(asset_hashes: &AssetHashes, sigs: &mut SignatureMap) {
