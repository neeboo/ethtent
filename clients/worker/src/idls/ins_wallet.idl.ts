export const idlFactory = ({ IDL }) => {
  ...
  const Result_6 = IDL.Variant({ 'Ok' : IDL.Text, 'Err' : WalletError });
  ...
  return IDL.Service({
    ...
    'wallet_collect' : IDL.Func([], [IDL.Vec(AddressInfo)], []),
    'wallet_config' : IDL.Func([ManualConfig], [], []),
    'wallet_fetch_estimate_gas' : IDL.Func(
        [IDL.Text, IDL.Vec(IDL.Nat8)],
        [Result_6],
        [],
      ),
    'wallet_fetch_gas_price' : IDL.Func([], [Result_6], []),
    'wallet_get_address_for_tx' : IDL.Func([TxInfo], [Result_6], []),
    'wallet_get_balance_of_order' : IDL.Func([IDL.Text], [Result_6], []),
    'wallet_get_orders' : IDL.Func([IDL.Text], [IDL.Vec(TxInfo)], ['query']),
    'wallet_get_tx' : IDL.Func([IDL.Text], [IDL.Opt(TxInfo)], ['query']),
    'wallet_get_tx_from_manager' : IDL.Func([IDL.Text], [IDL.Opt(TxInfo)], []),
    'wallet_push_tx' : IDL.Func([TxInfo], [Result_6], []),
    'wallet_send_from_address' : IDL.Func(
        [WalletSendFromAddress],
        [Result_6],
        [],
      ),
    'wallet_send_tx' : IDL.Func([WalletSendTx], [Result_6], []),
