export const idlFactory = ({ IDL }) => {
  ...
  const Result_6 = IDL.Variant({ Ok: TxInfoReturn, Err: IDL.Text });
  return IDL.Service({
    ...
    ego_owner_add_with_name: IDL.Func([IDL.Text, IDL.Principal], [Result_1], []),
    ...
    list_pic_preview: IDL.Func([], [IDL.Vec(ContentPreviewDetail)], []),
    list_unpaid_order: IDL.Func([], [IDL.Vec(OrderDetail)], []),
    manager_get_pic: IDL.Func([IDL.Text], [IDL.Opt(ContentDetail)], ['query']),
    manager_set_pic_price: IDL.Func([IDL.Nat64], [], []),
    manager_set_wallet: IDL.Func([IDL.Principal], [], []),
    manager_upload_pics: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Text, IDL.Vec(IDL.Nat8)))], [], []),
    manager_upload_preview_pics: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Text, IDL.Vec(IDL.Nat8)))], [], []),
    op_pay_order: IDL.Func([WalletSendTx], [Result_6], []),
    user_add_order: IDL.Func([IDL.Text, IDL.Text], [Result_6], []),
