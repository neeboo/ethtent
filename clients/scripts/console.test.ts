...
import { idlFactory as exampleIDL, idlFactory as egoIDL } from '@/idls/cross_dca.idl';
import { _SERVICE as exampleService, _SERVICE as egoService } from '@/idls/cross_dca';
  ...
  test('who am i', async () => {
    exampleActor =
      ...
      await getActor<exampleService>(
        ...
        exampleIDL,
        // get canister ID for 'cross_dca', `configs/cross_dca.json` is generated
        getCanisterId('cross_dca')!,
      );
